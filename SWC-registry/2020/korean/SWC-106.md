...
접근 제어가 누락되었거나 불충분하여 악의적인 당사자가 컨트랙트를 자체 파괴할 수 있습니다.

## 해결방법

자체 파괴 기능이 반드시 필요한 경우가 아니라면 제거하는 것을 고려하십시오. 유효한 사용 사례가 있는 경우 여러 당사자가 자체 파괴 작업을 승인해야 하도록 다중 서명 방식을 구현하는 것이 권장됩니다.
